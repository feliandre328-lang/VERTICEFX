import React, { useState, useRef, ClipboardEvent, KeyboardEvent, useEffect } from "react";
...
const TwoFactorAuth: React.FC = () => {
  ...
  const { handle2FAVerification, handleBackToRoleSelection } = useAuth();
